...
EXTRA_GAME_PARAMS_MAP = {
    ...
    'crewmates_3p_10r_10g': ('R=10', 'H=4', 'L=2', 'G=0.10'),
    'crewmates_3p_10r_20g': ('R=10', 'H=4', 'L=2', 'G=0.20'),
    'crewmates_3p_10r_30g': ('R=10', 'H=4', 'L=2', 'G=0.30'),
    'crewmates_3p_10r_5h_10g': ('R=10', 'H=5', 'L=2', 'G=0.10'),
    'crewmates_3p_10r_5h_20g': ('R=10', 'H=5', 'L=2', 'G=0.20'),
    'crewmates_3p_10r_5h_30g': ('R=10', 'H=5', 'L=2', 'G=0.30'),
    'crewmates_3p_10r_1l': ('R=10', 'H=4', 'L=1', 'G=0.1'),
    'crewmates_3p_10r_10g_1l': ('R=10', 'H=4', 'L=1', 'G=0.10'),
    'crewmates_3p_10r_20g_1l': ('R=10', 'H=4', 'L=1', 'G=0.20'),
    'crewmates_3p_10r_30g_1l': ('R=10', 'H=4', 'L=1', 'G=0.30'),
    'crewmates_3p_10r_5h_10g_1l': ('R=10', 'H=5', 'L=1', 'G=0.10'),
    'crewmates_3p_10r_5h_20g_1l': ('R=10', 'H=5', 'L=1', 'G=0.20'),
    'crewmates_3p_10r_5h_30g_1l': ('R=10', 'H=5', 'L=1', 'G=0.30'),
}
